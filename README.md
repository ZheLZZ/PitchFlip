...
上方显示刚翻过去那张纸的背面，下方显示下一张纸的正面。左侧按观看视角组织为**封面、2–3 页、4–5 页……封底**，每组标明上页和下页，与中央预览一致。右侧同时标明**原 PDF 页码、输出页码、物理纸张和正反面**。截图展示新版预览工作区，使用仓库自带的合成测试 PDF。
...
![新版页面总览：上下双页组合与插入空白的位置](docs/images/page-overview.png)
